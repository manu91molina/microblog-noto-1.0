<?
  ...
  if (@$ver_miembro ){
    ...
    echo "</br>";
    echo "<span class='libro_pushpin' title='publicaciones libres'><span class='glyphicon glyphicon-pushpin'></span></span>";

      $vector_de_publicaciones = consultar("select * from vista_publicacion where (idtipo_publi = 2 or idtipo_publi = 5 or idtipo_publi = 8 or idtipo_publi = 10) and miembro = $ver_miembro
