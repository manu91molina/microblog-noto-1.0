...
include"./configuraciones/correo-idmiembro.php";
      $vector_img_portada = consultar("select * from vista_publicacion where miembro = $miembroid and (idtipo_publi = 5 or idtipo_publi = 7)  order by fecha desc, tiempo desc;");
